...
def RWE_report (rpt, filename_pems, filename_obd, output_folder, now_hms, suffix, trip_distance, trip_duration, cold_start_duration, urban_distance, rural_distance, motorway_distance,
    ...
    nMAWu_pct, nMAWr_pct, nMAWm_pct = (1 - nMAWu_out/nMAWu)*100, (1 - nMAWr_out/nMAWr)*100, (1 - nMAWm_out/nMAWm)*100
...
plt.scatter(mean_vehspd_RDE, WLTC_NOx_comp_gpmi*1000, s=150, linewidth=3, marker="p", facecolors='none', edgecolors='m', label='WLTC Composite NOx')
...
plt.scatter(Composite_CO2_gpmi[0], Composite_NOx_mgpmi[0], s=150, linewidth=3, marker=">", facecolors='none', edgecolors='c', label='FTP Composite NOx')
plt.scatter(Composite_CO2_gpmi[1], Composite_NOx_mgpmi[1], s=150, linewidth=3, marker="<", facecolors='none', edgecolors='c', label='US06 Composite NOx')
plt.scatter(mean_GHG_gpmi, WLTC_NMHC_comp_gpmi*1000, s=150, linewidth=3, marker="p", facecolors='none', edgecolors='m', label='WLTC Composite NMHC')
...
plt.scatter(Composite_vehspd_kph[0], Composite_NOx_mgpmi[0], s=150, linewidth=3, marker=">", facecolors='none', edgecolors='c', label='FTP Composite NOx')
plt.scatter(Composite_vehspd_kph[1], Composite_NOx_mgpmi[1], s=150, linewidth=3, marker="<", facecolors='none', edgecolors='c', label='US06 Composite NOx')
plt.scatter(mean_vehspd_RDE, WLTC_NMHC_comp_gpmi*1000, s=150, linewidth=3, marker="p", facecolors='none', edgecolors='m', label='WLTC Composite NMHC')
...
plt.scatter(mean_GHG_gpmi, WLTC_CO_comp_gpmi, s=150, linewidth=3, marker="p", facecolors='none', edgecolors='m', label='WLTC Composite CO')
...
plt.scatter(mean_vehspd_RDE, WLTC_CO_comp_gpmi, s=150, linewidth=3, marker="p", facecolors='none', edgecolors='m', label='WLTC Composite CO')
