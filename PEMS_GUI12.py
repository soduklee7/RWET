...
class PEMS_GUI(object):
    def __init__(self, root):
        ...
        self.align_values_ent = tk.Entry(frame, textvariable=self.align_values_var, state="disabled")
