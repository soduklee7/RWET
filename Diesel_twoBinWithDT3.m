...
%% 2. RUN CALCULATIONS
[df, summary_df, windows_df, sub_interval_df, Invalid_count] = calculate_maw_and_subintervals(df, 507.0, 505.0);
...
function [df, summary, windows_df, sub_summary, Invalid_count] = calculate_maw_and_subintervals(df, eco2_g_hp_hr, pmax_hp)
    ...
    w_idx_BIN1 = 0; % Track actual stored windows
    w_idx_BIN2 = 0; % Track actual stored windows
    ...
    valid_wins = windows_df(windows_df.Bin ~= "InValid (Excluded > 599s)", :);
