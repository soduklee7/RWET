...
Create a Windows 11 color 600x735 size GUI using tkinter, pillow icons, and font size 12 for the following.
...
class Windows11GUI:
    def __init__(self, root):
        ...
        self.create_tooltip(self.btn_check_align, "Plot/View Alignment")
    ...
    def read_file(self):
        ...
        try:
            ...
            columns_row = temp_df.columns  # Original columns before assignment
